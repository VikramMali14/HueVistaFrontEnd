    ...
    <>
      ...
      <main id="main" style={{ maxWidth: 860, margin: "0 auto", padding: "72px var(--gutter) 140px" }}>
        ...
        <p style={{ marginTop: 48, font: "300 italic 17px/1.5 var(--serif)", color: "var(--fg-mute)" }}>
          ...
          <Link href="/unlock" style={{ color: "var(--accent-text)", borderBottom: "1px solid var(--rule-brass)" }}>
            unlock it here
          </Link>
          {" "}— or{" "}
          <Link href="/join" style={{ color: "var(--accent-text)", borderBottom: "1px solid var(--rule-brass)" }}>
