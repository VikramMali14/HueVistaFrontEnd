  ...
  return (
    <div style={{ maxWidth: 1080 }}>
      ...
      <Lead style={{ maxWidth: "60ch" }}>
        ...
        public site shows it — no release, no developer. Pick a file to see it in place first;
      ...
      >
        JPEG, PNG or WebP, up to 8 MB. These are downloaded by every visitor to the page they
        sit on, so export them at roughly the size they are shown rather than straight off the
        camera. Removing an image puts the built-in artwork back — nothing ever ends up blank.
      </p>
    </div>
  );
}
