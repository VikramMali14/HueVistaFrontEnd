...
const SECTIONS: ReadonlyArray<{ h: string; p: string }> = [
  ...
  },
  {
    ...
    p: "You keep ownership of the photographs you upload and the previews you create. You give us a limited licence to process them only in order to provide the service. Shade names, codes and colour data belong to the paint companies that publish them.",
  },
  {
    h: "7 · Paint company names",
    p: "HueVista is an independent product. It is not made, sponsored, endorsed or approved by any paint company, and we do not act for any of them. Company, product and shade names are their owners' trademarks, used here only to identify which company's shade you are looking at, so a shop can order the right tin. If a paint company would like a correction to how its range appears here, write to us and we will act on it.",
  },
  {
    h: "8 · Previews and shade colours",
    p: "Colour previews are generated by AI and are a guide, not an exact picture of the finished wall. Edges, textures and lighting can come out differently, results are not guaranteed, and we cannot promise any particular preview can be corrected. Shade colours shown here are taken from the paint companies' own shade cards and fan decks; screens, printing and lighting all shift colour, so what you see can differ from the paint in the tin. How paint finally looks also depends on the surface, the finish, the number of coats and the light in the room. Always check the physical shade card and, where it matters, a test patch, before buying. Colour decisions are yours; we are not liable for a choice made from an on-screen preview.",
  },
  {
