...
// The canvas → JPEG helpers moved to their own module so the studio can reach them
// without pulling this generator in with them; re-exported here so every existing
// importer of `pdf-export` keeps working unchanged.
export { canvasToJpegDataUrl, imageUrlToJpegDataUrl } from "./canvas-jpeg";
