...
export const ENTRIES: ReadonlyArray<JournalEntry> = [
  ...
  { num: "11", category: "Engineering", title: <>The <i>colour-matching problem</i>, or why approximate isn't good enough.</>, meta: "By the engineering desk · 9 min", date: "Feb 2026" },
