...
export const ENTRIES: ReadonlyArray<JournalEntry> = [
  ...
  { num: "16", category: "Case studies", title: <>From <i>let me think</i> to <i>same afternoon</i> — Sharda Paints, four months in.</>, meta: "With Suresh K. · 8 min", date: "May 2026" },
  ...
  { num: "12", category: "Press", title: <>HueVista featured in <i>The Hindu BusinessLine</i>.</>, meta: "Press · 3 min", date: "Mar 2026" },
  ...
  { num: "VIII.", category: "Essays", title: <>Why we begin <i>with the retailer</i> — and not the consumer.</>, meta: "A founding letter · 11 min", date: "Dec 2025" },
];
