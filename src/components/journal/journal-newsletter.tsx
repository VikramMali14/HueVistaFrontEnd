...
export function JournalNewsletter() {
  ...
  return (
    <section style={{ background: "#0a0805", padding: "140px 0", marginTop: 120, textAlign: "center" }} className="full-bleed">
      <div className="reveal" style={{ maxWidth: 1100, margin: "0 auto", padding: "0 var(--gutter)" }}>
        <Mono brass>Monthly letter</Mono>
        <h3 style={{ fontFamily: "var(--serif)", fontWeight: 300, fontSize: "clamp(40px, 5.5vw, 80px)", lineHeight: 1, letterSpacing: "-.015em", color: "var(--ivory)", margin: "24px 0 0" }}>
        ...
        >
          <input
            ...
            disabled={submitted}
            style={{ flex: 1, background: "transparent", border: "none", outline: "none", color: "var(--ivory)", font: "300 italic 18px/1 var(--serif)", padding: 0 }}
          />
