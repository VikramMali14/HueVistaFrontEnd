...
export function Closing() {
  return (
    <section aria-label="Get started" style={{ textAlign: "center", padding: "140px 0", background: "radial-gradient(ellipse at 50% 50%, rgba(124,92,255,.10), transparent 65%)" }}>
      <div className="reveal" style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 28 }}>
        ...
        <Mono>7-day trial · no card · open within a day</Mono>
      </div>
    </section>
  );
}
