...
export function Capabilities() {
  return (
    <section>
      <div className="reveal" style={{ display: "grid", gridTemplateColumns: "80px 1fr", gap: 48, marginBottom: 64 }}>
      ...
      <div className="reveal d1">
        {ROWS.map(([n, t, d], i) => (
          <div key={n} style={{ display: "grid", gridTemplateColumns: "80px 360px 1fr auto", alignItems: "baseline", gap: 40, padding: "32px 0", borderTop: "1px solid var(--rule)", borderBottom: i === ROWS.length - 1 ? "1px solid var(--rule)" : "none" }}>
            <Mono>{n}</Mono>
