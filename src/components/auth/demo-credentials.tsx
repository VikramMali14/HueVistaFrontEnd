  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }}>
        <span style={{ font: "500 12px/1 var(--mono)", letterSpacing: ".2em", textTransform: "uppercase", color: "var(--accent-text)" }}>
        ...
        {DEMO_ACCOUNT_LIST.map((acc) => (
          ...
          >
            <span style={{ display: "flex", alignItems: "baseline", gap: 8, flexWrap: "wrap" }}>
              ...
              <span style={{ font: "400 12px/1 var(--mono)", letterSpacing: ".16em", textTransform: "uppercase", color: "var(--accent-text)" }}>
                {acc.role}
              </span>
            </span>
