...
const FAQ: ReadonlyArray<{ q: string; a: string }> = [
  ...
  { q: "What if I use up my projects mid-month?", a: "Everything you have already made keeps working — trying more shades costs nothing. For a new project, buy one at a time at your plan's rate: 60 points or ₹65 on Starter, 50 or ₹55 on Professional, 40 or ₹45 on Business. You are offered it in the studio, at the photo that needs it. Or upgrade, and the bigger allowance applies straight away." },
