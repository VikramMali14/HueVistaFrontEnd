...
const FAQ: ReadonlyArray<{ q: string; a: string }> = [
  ...
  { q: "What if I use up my projects mid-month?", a: "Everything you have already made keeps working — trying more shades costs nothing. For a new project, buy one at a time at your plan's rate: 80 points or ₹99 on the free plan, 60 or ₹65 on Starter, 50 or ₹55 on Professional, 40 or ₹45 on Business. You are offered it in the studio, at the photo that needs it. Or wait for the month to turn over — the allowance comes back on every plan, free included. Or upgrade, and the bigger allowance applies straight away." },
  ...
  { q: "What is not in the free plan?", a: "One thing: the colour finder, which reads a photograph and gives you the nearest shade codes from your catalogue. Everything else is the same product — the full library, painting rooms, wall-by-wall colours, customer codes, sharing. Any paid plan switches the colour finder on." },
