...
const FAQ: ReadonlyArray<{ q: string; a: string }> = [
  ...
  { q: "What's the difference between AI auto-masks and manual masking?", a: "After the clean-up you choose how walls are marked. An AI auto-mask detects the walls for you in seconds and uses one auto-mask credit from your monthly allowance (5 on Starter, 40 on Professional, 90 on Business). Manual masking — clicking each wall in the studio — is free and unlimited on every plan." },
  { q: "What happens if I use all my images or auto-masks mid-month?", a: "The studio keeps working — every saved scene stays open and recolourable, since trying shades costs nothing. For new work you pay per use: ₹50 + GST (₹59) per extra image and ₹25 + GST (₹29.50) per extra AI auto-mask, deducted from your wallet or paid directly by UPI/card. Extras never expire. Or upgrade your plan — the fresh quota applies the moment the payment completes." },
  { q: "How does the wallet work?", a: "Add any amount (₹100 minimum) to your prepaid wallet by UPI, card or netbanking. When you run past a monthly allowance, the extra image or auto-mask is deducted from the balance with one tap — no checkout each time. The balance never expires; it's usage credit, not a deposit, so it isn't withdrawable. Every top-up gets a Razorpay tax invoice." },
